...
const CTA_LOGOS = [
  ...
  "/cta-logos/logo-8.jpg",
  "/cta-logos/logo-9.jpg",
  "/cta-logos/logo-10.png",
];
    ...
    <div className="min-h-screen">
      ...
      <section className="section-padding">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-3 gap-2 md:grid-cols-3 md:gap-4 lg:grid-cols-5">
            {catsLoading ? (
      ...
      {pageLoading ? (
        ...
        <section className="section-padding">
          <div className="container mx-auto px-1 sm:px-4">
            ...
            <div className="grid grid-cols-2 gap-1 sm:gap-8 max-w-none sm:max-w-5xl mx-auto">
              {featuredVideos.map((video: any, i: number) => (
                <div key={i} className="glass-card-hover overflow-hidden group flex flex-col">
                  <div className="aspect-[3/4] sm:aspect-square relative bg-black cursor-pointer overflow-hidden" onClick={() => toggleVideo(i)}>
                    {playingVideos[i] ? (
                      <iframe
                        width="100%"
                        height="100%"
                      ...
                      <>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-primary/90 text-primary-foreground flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-300">
                            <Play size={26} fill="currentColor" className="ml-0.5 sm:ml-1 sm:w-8 sm:h-8" />
                          </div>
                        </div>
                  ...
                  <div className="p-2 sm:p-6 bg-card mt-auto border-t">
                    <h3 className="font-display text-xs sm:text-lg font-semibold text-foreground group-hover:text-primary transition-colors text-center leading-tight">
                      {video.title}
                    </h3>
                  </div>
                </div>
        ...
        <div
          ...
          {CTA_LOGOS.length > 0 && (
            <div className="mb-6 grid grid-cols-5 justify-items-center gap-2 md:mb-8 md:flex md:flex-wrap md:items-center md:justify-center md:gap-5">
              {CTA_LOGOS.map((logo: string, index: number) => (
                <div
                  key={`${logo}-${index}`}
